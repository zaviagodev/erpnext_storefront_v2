...
import bannerBagProduct from "../img/banner-bag-product.png"
...
function RewardDetails() {
    return (
        <>
            ...
            <img src={bannerBagProduct} alt="" />
            <div className="w-[354px] h-[185px] relative mx-auto z-10 bg-white p-4 rounded-[10px] -mt-[18px]" style={{ boxShadow: "0px 4px 20px 0px #EBE9EA", }}>
            ...
            <div className='px-[18px] pt-[30px]'>
                ...
                <ul className='mt-[9px] px-[18px] w-[294px]'>
            ...
            <div className='mt-[140px] mb-3'>
                <button className='bg-[#111111] mx-auto w-[354px] h-[48px] py-3 rounded-[9px] text-[#FFFFFF] font-bold text-base flex items-center justify-center' style={{ fontFamily: "Eventpop" }}> แลกของรางวัล <img className='ml-[5px]' src={giftIcon} alt="" /> </button>
            </div>
        </>
    )
