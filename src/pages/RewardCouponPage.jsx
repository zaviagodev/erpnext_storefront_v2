...
function RewardCouponPage() {
    ...
    const tabs = [ 
        ...
        { name: 'หมดอายุ/ใช้แล้ว', content: tabData },
    ];
                                ...
                                <div className=" border-b border-[#E3E3E3]" key={index}>
                                    ...
                                    <div className='flex items-center'> 
                                        ...
                                        <div className='ml-[10px]'>
                                            <button class="bg-[#E9F6ED] h-[19px] rounded-full px-[10px] py-[4px] text-[#00B14F] font-bold text-[10px] leading-[11.1px]" style={{ fontFamily: "Eventpop" }}>{ data.tag }</button>
